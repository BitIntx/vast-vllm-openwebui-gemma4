...
`search_web`, `read_webpage`, `search_images`, `resolve_media_url`은 vLLM/Ollama 없이도 동작합니다. `inspect_image`, `inspect_image_deep`, `inspect_video`는 설정한 모델 백엔드를 사용합니다. `ocr_image`는 로컬 EasyOCR을 사용합니다.
