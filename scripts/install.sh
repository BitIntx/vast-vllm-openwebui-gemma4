...
"${WORKSPACE_DIR}/venvs/webui/bin/pip" install fastapi "uvicorn[standard]" httpx pydantic pillow imageio-ffmpeg easyocr pymupdf playwright psutil --no-cache-dir
